...
#define MTX_GET_DEF(_0, _1)                                                                                                                          \
    CHANSVmDefineMethod(MTX_GET(_0, _1)) {                                                                                                           \
        return get(VmInst, VmParentObj, VmReturnObj, _0, _1);                                                                                        \
    }

#define MTX_SET(_0, _1) set_##_0##_1
#define MTX_SET_DEF(_0, _1)                                                                                                                          \
    CHANSVmDefineMethod(MTX_SET(_0, _1)) {                                                                                                           \
