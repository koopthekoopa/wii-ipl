...
namespace ipl {
     ...
     * @note Size: 0x94
     */
    bs2::Manager::Manager(EGG::Heap* pHeap) :
    unk_0x04(1),
    mState(BS2_STATE_52),
    unk_0x0C(true),
    unk_0x0D(false),
    ...
    /**
     * @note Address: 0x813609A4
     * @note Size: 0x44
     */
    BOOL System::isRsrcLoaded() {
        BOOL result = FALSE;
        if (smArg.mbResLoaded && smArg.mbFontResLoaded && smArg.mbSndResLoaded && smArg.mbDictResLoaded) {
            result = TRUE;
        }
        return result;
    }
     ...
     * @note Size: 0x34
     */
    u32 bs2::Manager::getDiskBannerBuffer(void** pBuffer) {
     ...
     * @note Size: 0xC
     */
    void bs2::Manager::reserveRVLGame() {
        unk_0x0C = false;
    }
     ...
     * @note Size: 0xC
     */
    void bs2::Manager::reserveGCGame() {
        unk_0x0C = false;
    }
     ...
     * @note Size: 0x4
     */
    void bs2::Manager::startRVLGame() { bootNewSystem(); }

    /**
     * @note Address: 0x81360AD4
     * @note Size: 0x4
     */
    void bs2::Manager::startGCGame() { bootNewSystem(); }

    /**
     * @note Address: 0x81360AD8
     * @note Size: 0x14
     */
    void bs2::Manager::abort() {
        unk_0x0E = true;
        unk_0x0F = false;
    }
     ...
     * @note Size: 0x28
     */
    bool bs2::Manager::checkParentalControl() {
     ...
     * @note Size: 0x28
     */
    void bs2::Manager::getDiskInfo(char** diskID, char** diskMaker) {
     ...
     * @note Size: 0x74
     */
    BOOL bs2::Manager::isTitleAvailable(ESTitleId titleId) const {
        u32 count = 0;
     ...
     * @note Size: 0x10
     */
    s32 bs2::Manager::getTicketFromNand(ESTitleId titleId, ESTicketView* pTicketView) const {
     ...
     * @note Size: 0x48
     */
    void bs2::Manager::loadLockedTitleAsync(ESTitleId titleId, ESTicketView& ticketView) {
     ...
     * @note Size: 0x124
     */
    void bs2::Manager::splashTick(BS2State state) {
        switch(state) {
            case BS2_STATE_52:
            case BS2_STATE_53: { 
                unk_0x1C = BS2_STATE_52;
     ...
     * @note Size: 0xC4
     */
    void bs2::Manager::execTick(BS2State state) {
        if (unk_0x0D) {
     ...
     * @note Size: 0xF8
     */
    void bs2::Manager::bootNewSystem() {
