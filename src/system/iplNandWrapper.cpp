...
#define NAND_WRAPPER(r)                                                                                                                              \
    ...
    if (tries == MAX_TRIES) {                                                                                                                        \
        result = NAND_RESULT_FATAL_ERROR;                                                                                                            \
    }                                                                                                                                                \
    return result;
...
#define NAND_SAFE_WRAPPER(r)                                                                                                                         \
    ...
    return result;
            ...
            s32 SecretGetFileSystemStatus(NANDFileSystemStatus* status) {
                NAND_WRAPPER(NANDSecretGetFileSystemStatus(status));
            }
