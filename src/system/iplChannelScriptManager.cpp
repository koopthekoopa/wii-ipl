    ...
    {                                                                                                                                                \
        ...
        OSRestoreInterrupts(old);                                                                                                                    \
            ...
            while (TRUE) {
                ...
                if (result == CHANS_VM_ERR_SIGNAL && ((CHANSVmPrivate*)&smCSVm)->pbSignalPending == &VmSystemBeginRenderFlag) {
                ...
                if (result == CHANS_VM_ERR_SIGNAL && ((CHANSVmPrivate*)&smCSVm)->pbSignalPending == &VmSystemWaitForRetraceFlag) {
                    if (smCSState == CHANS_VM_STATE_UNK3) {
