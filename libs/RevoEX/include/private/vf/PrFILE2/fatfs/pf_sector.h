...
pf_s32 VFiPFSEC_ReadDataSector(PF_VOLUME* p_vol, pf_u8* p_buf, pf_u32 sector, pf_u32 size, pf_u32* p_success_size, pf_u32 set_sig);
pf_s32 VFiPFSEC_WriteData(PF_VOLUME* p_vol, const pf_u8* p_buf, pf_u32 sector, pf_u16 offset, pf_u32 size, pf_u32* p_success_size, pf_bool is_direct,
                          pf_bool set_sig);
pf_s32 VFiPFSEC_WriteDataSector(PF_VOLUME* p_vol, const pf_u8* p_buf, pf_u32 sector, pf_u32 size, pf_u32* p_success_size, pf_u32 is_direct,
                                pf_u32 set_sig);
