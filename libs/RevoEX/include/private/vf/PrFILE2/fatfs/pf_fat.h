...
pf_s32 VFiPFFAT_WriteValueToSpecifiedCluster(PF_VOLUME* p_vol, pf_u32 cluster, pf_u32 value);
pf_s32 VFiPFFAT_GetBeforeSector(pf_u32* p_befor_sector, PF_VOLUME* p_vo, pf_u32 current_sector);
