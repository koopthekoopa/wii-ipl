...
typedef enum CDBLocation { CDB_FS_LOCATION_NAND = 1, CDB_FS_LOCATION_SD, CDB_FS_LOCATION_3, CDB_FS_LOCATION_4 } CDBLocation;

typedef enum CDBSeek { CDB_SEEK_CUR = 0, CDB_SEEK_BEGIN, CDB_SEEK_END } CDBSeek;
