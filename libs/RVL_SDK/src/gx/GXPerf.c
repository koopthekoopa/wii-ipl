...
void GXSetGPMetric(GXPerf0 perf0, GXPerf1 perf1) {
    ...
    switch (__GXData->perf0) {
        case GX_PERF0_VERTICES:
            ...
            GX_WRITE_XF_REG(0x1006, reg);
            break;
        case GX_PERF0_CLIP_VTX:            { reg = 0x14A;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_CLIP_CLKS:           { reg = 0x16B;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_WAIT_IN:          { reg = 0x84;       GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_WAIT_OUT:         { reg = 0xC6;       GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_XFRM_CLKS:        { reg = 0x210;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_LIT_CLKS:         { reg = 0x252;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_BOT_CLKS:         { reg = 0x231;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_REGLD_CLKS:       { reg = 0x1AD;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_XF_REGRD_CLKS:       { reg = 0x1CE;      GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_CLOCKS:              { reg = 0x21;       GX_WRITE_XF_REG(0x1006, reg); break; }
        case GX_PERF0_CLIP_RATIO:          { reg = 0x153;      GX_WRITE_XF_REG(0x1006, reg); break; }
    ...
    switch (__GXData->perf1) {
        ...
        case GX_PERF1_VC_ELEMQ_FULL:    { SET_REG_FIELD(__GXData->perfSel, 4, 4, 2); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_MISSQ_FULL:    { SET_REG_FIELD(__GXData->perfSel, 4, 4, 3); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_MEMREQ_FULL:   { SET_REG_FIELD(__GXData->perfSel, 4, 4, 4); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_STATUS7:       { SET_REG_FIELD(__GXData->perfSel, 4, 4, 5); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_MISSREP_FULL:  { SET_REG_FIELD(__GXData->perfSel, 4, 4, 6); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_STREAMBUF_LOW: { SET_REG_FIELD(__GXData->perfSel, 4, 4, 7); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VC_ALL_STALLS:    { SET_REG_FIELD(__GXData->perfSel, 4, 4, 9); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
        case GX_PERF1_VERTICES:         { SET_REG_FIELD(__GXData->perfSel, 4, 4, 8); GX_WRITE_SOME_REG4(8, 0x20, __GXData->perfSel, -12); break; }
