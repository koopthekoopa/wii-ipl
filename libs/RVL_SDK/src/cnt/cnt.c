...
CNTError __CNTConvertErrorCode(s32 result) {
    int errorMap[] = {
        ...
        ES_ERR_MEMORY_ERROR,            CNT_RESULT_MEMORY_ERROR,
        ...
        ISFS_ERROR_BUSY,                CNT_RESULT_MEMORY_ERROR, // ...?
        ...
        IPL_RESULT_FULLQUEUE,           CNT_RESULT_MEMORY_ERROR,
        ...
        IPC_RESULT_ALLOC_FAILED,        CNT_RESULT_MEMORY_ERROR,
