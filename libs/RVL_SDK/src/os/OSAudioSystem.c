...
void __AIClockInit(BOOL compatB) {
    ...
    if (compatB == FALSE) {
        ...
        CLEAR_FLAG(reg, (1 << 6) | (1 << 7) | (0b11111111 << 8) | (1 << 16) | (1 << 17));
        SET_FLAG(reg, (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9) | (1 << 10) | (1 << 11));
        CLEAR_FLAG(reg, (1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5));
        CLEAR_FLAG(reg, (0b11111111 << 18) | (1 << 25) | (1 << 26));
        SET_FLAG(reg, ((1 << 0) | (1 << 3) | (1 << 4) | (1 << 8)) << 18);
        ACRIOP_WRITE_REG32(HW_PLLAI, reg);
    } else {
        reg = ACRIOP_READ_REG32(HW_PLLAI);
        CLEAR_FLAG(reg, (1 << 6) | (1 << 7) | (0b11111111 << 8) | (1 << 16) | (1 << 17));
        SET_FLAG(reg, (1 << 6) | (1 << 7) | (0b11111111 << 8));
        CLEAR_FLAG(reg, (1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5));
        SET_FLAG(reg, (1 << 1) | (1 << 2) | (1 << 3));
        CLEAR_FLAG(reg, (0b11111111 << 18) | (1 << 25) | (1 << 26));
        SET_FLAG(reg, ((1 << 2) | (1 << 3) | (1 << 5) | (1 << 8)) << 18);
        ACRIOP_WRITE_REG32(HW_PLLAI, reg);
    }
...
void __OSInitAudioSystem() {
    ...
    DSP_WRITE_REG(DSP_AR_SIZE, (1 << DSP_CONTROL_STATUS_ARINTMSK) | (1 << DSP_CONTROL_STATUS_PIINT) | (1 << DSP_CONTROL_STATUS_RES));
    DSP_WRITE_REG(DSP_CONTROL_STATUS, (1 << DSP_CONTROL_STATUS_RESET) | (1 << DSP_CONTROL_STATUS_DSPINT) | (1 << DSP_CONTROL_STATUS_ARINT) |
                                          (1 << DSP_CONTROL_STATUS_AIDINT) | (1 << DSP_CONTROL_STATUS_HALT));
