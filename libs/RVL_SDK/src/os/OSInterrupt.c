...
static u32 SetInterruptMask(OSInterruptMask mask, OSInterruptMask current) {
    ...
    switch (__cntlzw(mask)) {
        ...
        case __OS_INTERRUPT_DSP_DSP: {
            ...
            CLEAR_FLAG(reg, (1 << DSP_CONTROL_STATUS_AIDINT) | (1 << DSP_CONTROL_STATUS_AIDINTMSK) | (1 << DSP_CONTROL_STATUS_ARINT) |
                                (1 << DSP_CONTROL_STATUS_ARINTMSK) | (1 << DSP_CONTROL_STATUS_DSPINT) | (1 << DSP_CONTROL_STATUS_DMAINTMSK));
        ...
        case __OS_INTERRUPT_AI_AI: {
            ...
            CLEAR_FLAG(reg, (1 << AI_CONTROL_AIINTMSK) | (1 << AI_CONTROL_AIINT) | (1 << AI_CONTROL_SCRESET));
        ...
        case __OS_INTERRUPT_EXI_0_EXT: {
            ...
            CLEAR_FLAG(reg, (1 << EXI_CHAN_PARAM_INTMASK) | (1 << EXI_CHAN_PARAM_INT) | (1 << EXI_CHAN_PARAM_TCINTMASK) |
                                (1 << EXI_CHAN_PARAM_TCINT) | (1 << EXI_CHAN_PARAM_EXTINTMASK) | (1 << EXI_CHAN_PARAM_EXTINT) |
        ...
        case __OS_INTERRUPT_EXI_2_TC: {
            ...
            CLEAR_FLAG(reg,
                       (1 << EXI_CHAN_PARAM_INTMASK) | (1 << EXI_CHAN_PARAM_INT) | (1 << EXI_CHAN_PARAM_TCINTMASK) | (1 << EXI_CHAN_PARAM_TCINT));
        ...
        case __OS_INTERRUPT_PI_ACR: {
            reg = (1 << PI_INTERRUPT_EXI) | (1 << PI_INTERRUPT_AI) | (1 << PI_INTERRUPT_DSP) | (1 << PI_INTERRUPT_MEM);
