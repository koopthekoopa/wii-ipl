...
#define DefineVersion(package, lib, date, time)                                                                                                      \
    const char* __##lib##Version = "<< " STRDEF(package) " - " STRDEF(lib) BUILD_TYPE __DATE__ " "__TIME__                                           \
                                                                                               " (" STRDEF(__CWCC__) "_" STRDEF(__CWBUILD__) ") >>"
#define DefineVersionEx(package, lib, date, time, cwbuild)                                                                                           \
    const char* __##lib##Version = "<< " STRDEF(package) " - " STRDEF(lib) BUILD_TYPE __DATE__ " "__TIME__                                           \
                                                                                               " (" STRDEF(__CWCC__) "_" STRDEF(cwbuild) ") >>"
#else
#define DefineVersion(package, lib, date, time)                                                                                                      \
    const char* __##lib##Version =                                                                                                                   \
        "<< " STRDEF(package) " - " STRDEF(lib) BUILD_TYPE date " " time " (" STRDEF(__CWCC__) "_" STRDEF(__CWBUILD__) ") >>"
#define DefineVersionEx(package, lib, date, time, cwbuild)                                                                                           \
