 ...
 */
#define ENC_UTF7_STATE_COLLECT(partialBits_, partialOffset_)    (ENC_UTF7_STATE_BASE64_MODE | ((partialBits_) & 0xfffc0000) | ((partialOffset_) >> 1 & 0x00000007l)) // ?

typedef ENCMBState ENCUTF16State;
enum {
    ENC_UTF16_STATE_BIG_ENDIAN,
