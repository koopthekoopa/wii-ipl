...
{
	char				svc_name[HID_MAX_SVC_NAME_LEN];		// 0x00
	char				svc_descr[HID_MAX_SVC_DESCR_LEN];	// 0x20
	char				prov_name[HID_MAX_PROV_NAME_LEN];	// 0x40
	UINT16				rel_num;							// 0x60
	...
	tSDP_DISC_REC		*p_sdp_layer_rec;					// 0x70
