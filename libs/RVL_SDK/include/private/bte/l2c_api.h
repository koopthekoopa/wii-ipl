...
{
	UINT8	mode;			// 0x00
	UINT8	tx_win_sz;		// 0x01
	UINT8	max_transmit;	// 0x02
	/* 1 byte padding */
	UINT16	rtrans_tout;	// 0x04
	UINT16	mon_tout;		// 0x06
	UINT16	mps;			// 0x08
	UINT8	tx_pool_id;		// 0x0a
	/* 1 byte padding */
	UINT16	tx_buf_sz;		// 0x0c
	UINT8	rx_pool_id;		// 0x0e
	/* 1 byte padding */
...
typedef struct
{
	tL2CA_CONNECT_IND_CB		*pL2CA_ConnectInd_Cb;		// 0x00
	tL2CA_CONNECT_CFM_CB		*pL2CA_ConnectCfm_Cb;		// 0x04
	tL2CA_CONNECT_PND_CB		*pL2CA_ConnectPnd_Cb;		// 0x08
	tL2CA_CONFIG_IND_CB			*pL2CA_ConfigInd_Cb;		// 0x0c
	tL2CA_CONFIG_CFM_CB			*pL2CA_ConfigCfm_Cb;		// 0x10
	tL2CA_DISCONNECT_IND_CB		*pL2CA_DisconnectInd_Cb;	// 0x14
	tL2CA_DISCONNECT_CFM_CB		*pL2CA_DisconnectCfm_Cb;	// 0x18
	tL2CA_QOS_VIOLATION_IND_CB	*pL2CA_QoSViolationInd_Cb;	// 0x1c
	tL2CA_DATA_IND_CB			*pL2CA_DataInd_Cb;			// 0x20
	tL2CA_CONGESTION_STATUS_CB	*pL2CA_CongestionStatus_Cb;	// 0x24
