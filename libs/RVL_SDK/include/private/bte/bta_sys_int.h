...
typedef struct
{
	tBTA_SYS_REG		*reg[BTA_ID_MAX];	// 0x00
	tPTIM_CB			ptim_cb;			// 0x68
	UINT8				timers_disabled;	// 0x7c
	UINT8				task_id;			// 0x7d
	UINT8				events_disabled;	// 0x7e
	tBTA_SYS_CONN_CBACK	*prm_cb;			// 0x80
	tBTA_SYS_CONN_CBACK	*ppm_cb;			// 0x84
	tBTA_SYS_CONN_CBACK	*compress_cb;		// 0x88
