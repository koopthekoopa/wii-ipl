...
typedef struct host_ctb
{
	...
	tHID_HOST_DEV_CALLBACK	*callback;						// 0x340
	tL2CAP_CFG_INFO			l2cap_cfg;						// 0x344
	BOOLEAN					sdp_busy;						// 0x380
	/* 3 bytes padding */
	tHID_HOST_SDP_CALLBACK	*sdp_cback;						// 0x384
	tSDP_DISCOVERY_DB		*p_sdp_db;						// 0x388
	tHID_DEV_SDP_INFO		sdp_rec;						// 0x38c
	BOOLEAN					reg_flag;						// 0x400
