...
typedef struct
{
	tPORT_BAUD_RATE		baud_rate;		// 0x00
	tPORT_BYTE_SIZE		byte_size;		// 0x01
	tPORT_STOP_BITS		stop_bits;		// 0x02
	UINT8				parity;			// 0x03
	tPORT_PARITY_TYPE	parity_type;	// 0x04
	UINT8				fc_type;		// 0x05
	UINT8				rx_char1;		// 0x06
	UINT8				xon_char;		// 0x07
	UINT8				xoff_char;		// 0x08
...
typedef struct
{
	tPORT_STATUS_FLAGS	flags;			// 0x00
	UINT16				in_queue_size;	// 0x02
	UINT16				out_queue_size;	// 0x04
	UINT16				mtu_size;		// 0x06
