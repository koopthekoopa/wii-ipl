...
typedef struct
{
	UINT8					qos_flags;			// 0x00
	tFLOW_SPEC_SERVICE_TYPE	service_type;		// 0x01
	/* 2 bytes padding */
	UINT32					token_rate;			// 0x04
	UINT32					token_bucket_size;	// 0x08
	UINT32					peak_bandwidth;		// 0x0c
	UINT32					latency;			// 0x10
	UINT32					delay_variation;	// 0x14
} FLOW_SPEC; // size 0x18
