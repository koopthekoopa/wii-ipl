...
static void __ull2dec(decimal* pDecimal, unsigned long long input) {
    pDecimal->sign = 0;
...
static void __timesdec(decimal* pResult, const decimal* x, const decimal* y) {
...
static void __str2dec(decimal* pDecimal, const char* pStr, short exp) {
    int i;
...
static void __num2dec_internal(decimal* pDecimal, double x) {
...
double __dec2num(const decimal* d) {
    ...
    }
    {
        ...
        if (__fpclassifyd(first_guess) == 2) {
            first_guess = 1.7976931348623157e+308;
        }
