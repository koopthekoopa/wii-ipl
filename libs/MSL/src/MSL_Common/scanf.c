...
__declspec(section ".rodata") scan_format defaultScanFormat = {0, 0, normal_argument, 0, INT_MAX, {0}};
    ...
    switch (c) {
        ...
        case 'G': {
            if (f.argument_options == char_argument || f.argument_options == short_argument || f.argument_options == intmax_argument ||
                f.argument_options == size_t_argument || f.argument_options == ptrdiff_argument || f.argument_options == long_long_argument) {
                f.conversion_char = 0xFF;
                break;
            }
        ...
        switch (format.conversion_char) {
            ...
            signed_int:
                ...
                if (match_failure) {
                    ...
                    if ((format.argument_options == long_long_argument) || (format.argument_options == intmax_argument)) {
                        if (negative)
                            long_long_num = -(long long)u_long_long_num;
                        else
                            long_long_num = (long long)u_long_long_num;
                    } else {
                        if (negative)
                            long_num = -(long)u_long_num;
                        else
                            long_num = (long)u_long_num;
                    }
                }
                ...
                if (arg_ptr) {
                    switch (format.argument_options) {
                        case normal_argument:
                            *(int*)arg_ptr = (int)long_num;
                            break;
                        case char_argument:
                            *(signed char*)arg_ptr = (signed char)long_num;
                            break;
                        case short_argument:
                            *(short*)arg_ptr = (short)long_num;
                            break;
                        case long_argument:
                        ...
                        case ptrdiff_argument:
                            *(ptrdiff_t*)arg_ptr = (ptrdiff_t)long_num;
                            break;
            ...
            unsigned_int_assign:
                ...
                if (arg_ptr) {
                    switch (format.argument_options) {
                        case normal_argument:
                            *(unsigned int*)arg_ptr = (unsigned int)u_long_num;
                            break;
                        case char_argument:
                            *(unsigned char*)arg_ptr = (unsigned char)u_long_num;
                            break;
                        case short_argument:
                            *(unsigned short*)arg_ptr = (unsigned short)u_long_num;
                            break;
                        case long_argument:
                            *(unsigned long*)arg_ptr = u_long_num;
                            break;
                        case intmax_argument:
                            *(long long*)arg_ptr = (long long)u_long_long_num;
                            break;
                        case size_t_argument:
                            *(size_t*)arg_ptr = (size_t)u_long_num;
                            break;
                        case ptrdiff_argument:
            ...
            assign_float:
                ...
                if (arg_ptr) {
                    switch (format.argument_options) {
                        case normal_argument:
                            *(float*)arg_ptr = (float)long_double_num;
                            break;
                        case double_argument:
                            *(double*)arg_ptr = (double)long_double_num;
                            break;
            ...
            case 'c': {
                ...
                if (arg_ptr) {
                    ...
                    if (match_failure) {
                        ...
                        while (format.field_width-- && (!is_secure || ((elem_valid = (elem_maxsize > num_chars)) != 0)) &&
                    ...
                    switch (format.argument_options) {
                        case normal_argument:
                            *(int*)arg_ptr = chars_read;
                            break;
                        case short_argument:
                            *(short*)arg_ptr = (short)chars_read;
                            break;
                        case long_argument:
                            *(long*)arg_ptr = chars_read;
                            break;
                        case char_argument:
                            *(char*)arg_ptr = (char)chars_read;
                            break;
                        case long_long_argument:
...
int sscanf(const char* s, const char* pFormat, ...) {
    ...
    isc.spNextChar = (char*)s;

    if ((s == NULL) || (*isc.spNextChar == '\0')) {
        return -1;
    }
