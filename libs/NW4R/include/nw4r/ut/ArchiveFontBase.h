...
namespace nw4r {
    namespace ut {
        namespace detail {
            static const int GLYPH_INDEX_NOT_FOUND = 0xFFFF;
            ...
            public:
                ...
                typedef enum {
                    CONSTRUCT_STATE_DATA_REQUESTED = 0,
                    CONSTRUCT_STATE_DONE,
                    CONSTRUCT_STATE_FATAL_ERR,
                    CONSTRUCT_STATE_WORKING,
                } ConstructState;

                typedef enum {
                    CONSTRUCT_CMD_DISPATCH = 0,
                    CONSTRUCT_CMD_ANALYZE_FILE_HEADER,
                    CONSTRUCT_CMD_ANALYZE_GLGR,
                    CONSTRUCT_CMD_ANALYZE_FINF,
                    CONSTRUCT_CMD_ANALYZE_CMAP,
                    CONSTRUCT_CMD_ANALYZE_CWDH,
                    CONSTRUCT_CMD_ANALYZE_TGLP,
                    CONSTRUCT_CMD_PREPAIR_COPY_SHEET,
                    CONSTRUCT_CMD_PREPAIR_EXPAND_SHEET,
                    CONSTRUCT_CMD_COPY,
                    CONSTRUCT_CMD_SKIP,
                    CONSTRUCT_CMD_EXPAND,
                    CONSTRUCT_CMD_FATAL_ERR,

                    CONSTRUCT_CMD_MAX_CMD,
                    CONSTRUCT_CMD_INVALID,
                } ConstructCmd;
...
#endif  // NW4R_UT_ARCHIVE_FONT_BASE_H
