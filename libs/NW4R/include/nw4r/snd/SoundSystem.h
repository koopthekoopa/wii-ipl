...
namespace nw4r {
    namespace snd {
        ...
        public:
            ...
            static void SetMasterVolume(f32 volume, int frame) { detail::AxManager::GetInstance().SetMasterVolume(volume, frame); }

            static RemoteSpeaker& GetRemoteSpeaker(int idx) { return detail::RemoteSpeakerManager::GetInstance().GetRemoteSpeaker(idx); }
