...
namespace nw4r {
    namespace snd {
        ...
        public:
            ...
            virtual StartResult detail_SetupSound(SoundHandle* soundHandle, u32 id, detail::BasicSound::AmbientArgInfo* ambientArgInfo,
            ...
            bool StartSound(SoundHandle* soundHandle, u32 id) { return detail_StartSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }
            ...
            bool StartSound(SoundHandle* soundHandle, int id) { return detail_StartSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }

            bool HoldSound(SoundHandle* soundHandle, u32 id) { return detail_HoldSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }
            bool HoldSound(SoundHandle* soundHandle, unsigned int id) { return detail_HoldSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }
            bool HoldSound(SoundHandle* soundHandle, int id) { return detail_HoldSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }

            bool PrepareSound(SoundHandle* soundHandle, u32 id) { return detail_PrepareSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }
            ...
            bool PrepareSound(SoundHandle* soundHandle, int id) { return detail_PrepareSound(soundHandle, id, NULL, NULL, NULL) == START_SUCCESS; }
        ...
        private:
            ...
            StartResult detail_PrepareSound(SoundHandle* soundHandle, u32 id, detail::BasicSound::AmbientArgInfo* ambientArgInfo,
                                            detail::ExternalSoundPlayer* extPlayer, const StartInfo* startInfo);
        };
