...
namespace nw4r {
    namespace ut {
        NW4R_UT_GET_DERIVED_RUNTIME_TYPEINFO(NandFileStream, FileStream);
        ...
        bool NandFileStream::ReadAsync(void* pDst, u32 size, IOStreamCallback callback, void* callbackArg) {
            ...
            bool success = NANDReadAsync(&mFileInfo.nandInfo, pDst, size, NandAsyncCallback_, &mFileInfo.nandBlock) == NAND_RESULT_OK;
        ...
        bool NandFileStream::WriteAsync(const void* pSrc, u32 size, IOStreamCallback callback, void* callbackArg) {
            ...
            s32 result = NANDWriteAsync(&mFileInfo.nandInfo, pSrc, size, NandAsyncCallback_, &mFileInfo.nandBlock);
