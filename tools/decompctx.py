...
include_dirs = [
    ...
    os.path.join(root_dir, "include/decomp"),
    os.path.join(root_dir, "libs/EGG/include"),
    os.path.join(root_dir, "libs/MSL/include"),
    os.path.join(root_dir, "libs/NW4R/include"),
    os.path.join(root_dir, "libs/RevoEX/include"),
    os.path.join(root_dir, "libs/Runtime/include"),
    os.path.join(root_dir, "libs/RVL_SDK/include"),
    os.path.join(root_dir, "libs/RVLFaceLib/include")
]
