...
namespace ipl {
    namespace nand {
        ...
        public:
            ...
            SharedFile* readSharedAsync(EGG::Heap* heap, const char* fileName, int index, int offset = 0, u32 length = 0,
                                        ESTitleId titleId = SYSMENU_TITLE_ID, int ticketIdx = 0);

            MetaFile* readMetaHeaderAsync(EGG::Heap* heap, ESTitleId titleId, int offset, u32 length, MetaFile::Callback callback, void* callbackWork,
                                          int ticketIdx);
            MetaFile* readMetaBodyAsync(EGG::Heap* heap, const char* fileName, ARCHandle* arc, ESTitleId titleId, int offset, u32 length,
