...
namespace ipl {
    namespace cdb {
        ...
        public:
            ...
            BOOL writeRecord(CDBRecord* record, const math::VEC2& recordPos, u32 recordFlags, const NWC24FriendAddr& addr, u16 addrType,
            ...
            BOOL createAtOnce(CDBRecord* record, const char* recordName, const char* recordFileType, u32* gameCode, u16* makerCode,
            ...
            void unused() { utility::autoMutexLock lock(mMutex); }

            void unused2() { utility::autoMutexLock lock(mMutex); }
        ...
        public:
            ...
            ~auto_closer() { mpCDBMgr->close(mpRecord); }
