...
namespace ipl {
    namespace scene {
        ...
        public:
            event(focus_object* instance) : ::gui::EventHandler(), mpInstance(instance) {}
        ...
        public:
            button_event(focus_object* instance) : ButtonEventHandlerBase(), mpInstance(instance) {}
        ...
        public:
            optout_button_event(focus_object* instance) : OptOutButtonEventHandlerBase(), mpInstance(instance) {}
