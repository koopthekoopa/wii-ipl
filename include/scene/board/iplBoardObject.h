...
namespace ipl {
    namespace scene {
        typedef struct picture {
            picture() : mpRGB565(NULL), mpWork(NULL), width(0), height(0) {}
        ...
        public:
            ...
            void create(nand::LayoutFile* file, u8* recordData, u32 gameCode, const CDBId& cdbId, const CDBRecordKey& recordKey,
