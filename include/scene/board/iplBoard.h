...
namespace ipl {
    namespace scene {
        ...
        public:
            ...
            nand::LayoutFile* getLayoutFile() const {
                return mpLayoutFile;
            }
            ...
            bool canPlayDispSound() const {
                return mbPlayDispSound;
            }
            CDBSearchDirection getSearchDirection() const {
                return mSearchDirection;
            }

            void setHoveredObj(int index, BoardObject* boardObject) {
                mHoveredObjs[index] = boardObject;
            }
            BoardObject* getHoveredObj(int index) {
                return mHoveredObjs[index];
            }
        ...
        private:
            ...
            public:
                ...
                BoardObject* getNextFree(BoardObject* obj = NULL) { return (BoardObject*)nw4r::ut::List_GetNext(&mFreeObjs, obj); }
