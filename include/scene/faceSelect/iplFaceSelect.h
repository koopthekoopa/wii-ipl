...
namespace ipl {
    namespace scene {
        ...
        public:
            FaceSelectEvent(FaceSelect* instance) : ::gui::EventHandler(), mpInstance(instance) {}
        ...
        public:
            FaceSelectButtonEvent(FaceSelect* instance) : ButtonEventHandlerBase(), mpInstance(instance) {}
