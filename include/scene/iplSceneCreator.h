...
namespace ipl {
    enum {
        ...
        // These are not actual scenes, but the values are used for channels
        // But... why is one of them using the same value as SCENE_MEMORY_CARD???
        SCENE_NORMAL_CHANNEL = SCENE_MEMORY_CARD, /* 0x0E, 14 */
        SCENE_DISK_CHANNEL,                       /* 0x0F, 15 */
        SCENE_UNUSED_16,                          /* 0x10 */
        SCENE_UNLOCKED_TITLE,                     /* 0x11, 17 */
        ...
        // Same thing for ID 14-17
        SCENE_LOCKED_TITLE, /* 0x21, 33 */
    ...
    namespace scene {
        ...
        public:
            enum {
                SMALL_SIZE = 0x0000DC00,
                MEDIUM_SIZE = 0x000AF000,
                BIG_SIZE = 0x0012C000,
            };
