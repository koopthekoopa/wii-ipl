...
#define EXTERN_IPL_LIB(l)                                                                                                                            \
    namespace l {                                                                                                                                    \
        BOOL init(CHANSVm* vm);                                                                                                                      \
    }

#define EXTERN_IPL_LIB_CTOR(l)                                                                                                                       \
    namespace l {                                                                                                                                    \
        BOOL _ctor(CHANSVm* VmInst, CHANSVmObjHdr* VmObj);                                                                                           \
    }
#define EXTERN_IPL_LIB_CTOR_ARG(l, ...)                                                                                                              \
    namespace l {                                                                                                                                    \
        BOOL _ctor(CHANSVm* VmInst, CHANSVmObjHdr* VmObj, __VA_ARGS__);                                                                              \
    }
...
namespace ipl {
    namespace cs {
        ...
        EXTERN_IPL_LIB_CTOR_ARG(pane, u32 pane) EXTERN_IPL_LIB(material) EXTERN_IPL_LIB_CTOR_ARG(material, u32 material) EXTERN_IPL_LIB(texture)
            ...
            EXTERN_IPL_LIB(gx)
            // Text
            EXTERN_IPL_LIB(textwriter) EXTERN_IPL_LIB(font) EXTERN_IPL_LIB_CTOR_ARG(font, u32 font)
            // Rectangle
            EXTERN_IPL_LIB(rect) EXTERN_IPL_LIB_CTOR(rect) EXTERN_IPL_LIB(size) EXTERN_IPL_LIB_CTOR_ARG(size, f32 width, f32 height)
            // Color
            EXTERN_IPL_LIB(color) EXTERN_IPL_LIB_CTOR_ARG(color, nw4r::ut::Color color) EXTERN_IPL_LIB(color_s10)
                EXTERN_IPL_LIB_CTOR_ARG(color_s10, GXColorS10 color)
            // Animation
