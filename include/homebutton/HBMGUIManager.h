...
#define GUI_POINTS_MAX 8
        ...
        public:
            ...
            Component(u32 id) : Interface(), mbDragging(false), mDraggingButton(0), mID(id), mbTriggerTarget(false), mpManager(NULL) { init(); }
        ...
        public:
            ...
            Manager(EventHandler* event, MEMAllocator* allocator) : Interface(), mpEventHandler(event), mpAllocator(allocator) {
        ...
        protected:
            class IDToComponent {
            public:
                IDToComponent(u32 id, Component* component) : mID(id), mpComponent(component) {}
        ...
        public:
            PaneComponent(u32 id) : Component(id) { mpPane = NULL; }
