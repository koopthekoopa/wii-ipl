...
# ipl::scene::SDMemory::SDMemory()
.fn __ct__Q33ipl5scene8SDMemoryFv, global
...
.endfn __ct__Q33ipl5scene8SDMemoryFv

# .text:0x48 | 0x813EB634 | size: 0x5C
# ipl::scene::SDMemory::~SDMemory()
.fn __dt__Q33ipl5scene8SDMemoryFv, global
...
.endfn __dt__Q33ipl5scene8SDMemoryFv

# .text:0xA4 | 0x813EB690 | size: 0x10A0
.fn iplSDMemory_813EB690, global
...
.endfn iplSDMemory_813EB690

# .text:0x1144 | 0x813EC730 | size: 0xD4
.fn iplSDMemory_813EC730, global
...
.endfn iplSDMemory_813EC730

# .text:0x1218 | 0x813EC804 | size: 0x144
.fn iplSDMemory_813EC804, global
...
/* 813EC918 | 48 00 00 31 */	bl iplSDMemory_813EC948
...
.endfn iplSDMemory_813EC804

# .text:0x135C | 0x813EC948 | size: 0x20
.fn iplSDMemory_813EC948, global
...
.endfn iplSDMemory_813EC948

# .text:0x137C | 0x813EC968 | size: 0x84
.fn iplSDMemory_813EC968, global
...
/* 813EC9D4 | 48 00 01 29 */	bl iplSDMemory_813ECAFC
.L_813EC9D8:
...
.endfn iplSDMemory_813EC968

# .text:0x1400 | 0x813EC9EC | size: 0x9C
.fn iplSDMemory_813EC9EC, global
...
/* 813ECA24 | 48 00 01 4D */	bl iplSDMemory_813ECB70
.L_813ECA28:
...
/* 813ECA3C | 48 00 00 4D */	bl iplSDMemory_813ECA88
.L_813ECA40:
...
/* 813ECA54 | 48 00 01 95 */	bl iplSDMemory_813ECBE8
.L_813ECA58:
...
/* 813ECA6C | 48 00 00 91 */	bl iplSDMemory_813ECAFC
.L_813ECA70:
...
.endfn iplSDMemory_813EC9EC

# .text:0x149C | 0x813ECA88 | size: 0x74
.fn iplSDMemory_813ECA88, global
...
.endfn iplSDMemory_813ECA88

# .text:0x1510 | 0x813ECAFC | size: 0x74
.fn iplSDMemory_813ECAFC, global
...
.endfn iplSDMemory_813ECAFC

# .text:0x1584 | 0x813ECB70 | size: 0x78
.fn iplSDMemory_813ECB70, global
...
.endfn iplSDMemory_813ECB70

# .text:0x15FC | 0x813ECBE8 | size: 0x78
.fn iplSDMemory_813ECBE8, global
...
.endfn iplSDMemory_813ECBE8

# .text:0x1674 | 0x813ECC60 | size: 0x160
.fn iplSDMemory_813ECC60, global
...
/* 813ECCBC | 48 00 01 05 */	bl iplSDMemory_813ECDC0
.L_813ECCC0:
...
/* 813ECCE8 | 48 00 01 99 */	bl iplSDMemory_813ECE80
.L_813ECCEC:
...
/* 813ECD14 | 48 00 01 0D */	bl iplSDMemory_813ECE20
.L_813ECD18:
...
/* 813ECD40 | 48 00 01 A5 */	bl iplSDMemory_813ECEE4
...
/* 813ECD5C | 48 00 00 65 */	bl iplSDMemory_813ECDC0
.L_813ECD60:
...
/* 813ECD74 | 48 00 01 0D */	bl iplSDMemory_813ECE80
.L_813ECD78:
...
/* 813ECD8C | 48 00 00 95 */	bl iplSDMemory_813ECE20
.L_813ECD90:
...
/* 813ECDA4 | 48 00 01 41 */	bl iplSDMemory_813ECEE4
.L_813ECDA8:
...
.endfn iplSDMemory_813ECC60

# .text:0x17D4 | 0x813ECDC0 | size: 0x60
.fn iplSDMemory_813ECDC0, global
...
.endfn iplSDMemory_813ECDC0

# .text:0x1834 | 0x813ECE20 | size: 0x60
.fn iplSDMemory_813ECE20, global
...
.endfn iplSDMemory_813ECE20

# .text:0x1894 | 0x813ECE80 | size: 0x64
.fn iplSDMemory_813ECE80, global
...
.endfn iplSDMemory_813ECE80

# .text:0x18F8 | 0x813ECEE4 | size: 0x64
.fn iplSDMemory_813ECEE4, global
...
.endfn iplSDMemory_813ECEE4

# .text:0x195C | 0x813ECF48 | size: 0x13C
.fn iplSDMemory_813ECF48, global
...
.endfn iplSDMemory_813ECF48

# .text:0x1A98 | 0x813ED084 | size: 0x268
.fn iplSDMemory_813ED084, global
...
/* 813ED0A0 | 48 00 02 4D */	bl iplSDMemory_813ED2EC
...
/* 813ED0D4 | 4B FF FE 75 */	bl iplSDMemory_813ECF48
.L_813ED0D8:
...
/* 813ED140 | 48 00 06 79 */	bl iplSDMemory_813ED7B8
...
.endfn iplSDMemory_813ED084

# .text:0x1D00 | 0x813ED2EC | size: 0x4CC
.fn iplSDMemory_813ED2EC, global
...
/* 813ED5B0 | 4B FF F3 99 */	bl iplSDMemory_813EC948
...
/* 813ED5CC | 4B FF F5 A5 */	bl iplSDMemory_813ECB70
.L_813ED5D0:
...
/* 813ED5E0 | 4B FF F6 09 */	bl iplSDMemory_813ECBE8
.L_813ED5E4:
...
/* 813ED5FC | 4B FF F3 4D */	bl iplSDMemory_813EC948
...
.endfn iplSDMemory_813ED2EC

# .text:0x21CC | 0x813ED7B8 | size: 0xA4
.fn iplSDMemory_813ED7B8, global
...
.endfn iplSDMemory_813ED7B8

# .text:0x2270 | 0x813ED85C | size: 0xC4
.fn iplSDMemory_813ED85C, global
...
.endfn iplSDMemory_813ED85C

# .text:0x2334 | 0x813ED920 | size: 0x124
.fn iplSDMemory_813ED920, global
...
.endfn iplSDMemory_813ED920

# .text:0x2458 | 0x813EDA44 | size: 0x110
.fn iplSDMemory_813EDA44, global
...
.endfn iplSDMemory_813EDA44

# .text:0x2568 | 0x813EDB54 | size: 0x78
.fn iplSDMemory_813EDB54, global
...
.endfn iplSDMemory_813EDB54

# .text:0x25E0 | 0x813EDBCC | size: 0xC0
.fn iplSDMemory_813EDBCC, global
...
.endfn iplSDMemory_813EDBCC

# .text:0x26A0 | 0x813EDC8C | size: 0x278
.fn iplSDMemory_813EDC8C, global
...
/* 813EDEE0 | 4B FF E9 25 */	bl iplSDMemory_813EC804
/* 813EDEE4 | 7F E3 FB 78 */	mr r3, r31
/* 813EDEE8 | 4B FF EA 81 */	bl iplSDMemory_813EC968
.L_813EDEEC:
...
.endfn iplSDMemory_813EDC8C

# .text:0x2918 | 0x813EDF04 | size: 0xA4
.fn iplSDMemory_813EDF04, global
...
.endfn iplSDMemory_813EDF04

# .text:0x29BC | 0x813EDFA8 | size: 0x130
.fn iplSDMemory_813EDFA8, global
...
/* 813EDFD8 | 4B FF EC 89 */	bl iplSDMemory_813ECC60
...
/* 813EE08C | 4B FF E9 61 */	bl iplSDMemory_813EC9EC
...
.endfn iplSDMemory_813EDFA8

# .text:0x2AEC | 0x813EE0D8 | size: 0xE0
.fn iplSDMemory_813EE0D8, global
...
/* 813EE17C | 4B FF E9 F5 */	bl iplSDMemory_813ECB70
.L_813EE180:
...
/* 813EE190 | 4B FF EA 59 */	bl iplSDMemory_813ECBE8
...
.endfn iplSDMemory_813EE0D8

# .text:0x2BCC | 0x813EE1B8 | size: 0x1A0
.fn iplSDMemory_813EE1B8, global
...
.endfn iplSDMemory_813EE1B8

# .text:0x2D6C | 0x813EE358 | size: 0x44
.fn iplSDMemory_813EE358, global
...
.endfn iplSDMemory_813EE358

# .text:0x2DB0 | 0x813EE39C | size: 0xEC
.fn iplSDMemory_813EE39C, global
...
/* 813EE3F8 | 4B FF FF 61 */	bl iplSDMemory_813EE358
...
.endfn iplSDMemory_813EE39C

# .text:0x2E9C | 0x813EE488 | size: 0x1C4
.fn iplSDMemory_813EE488, global
...
/* 813EE528 | 4B FF FE 31 */	bl iplSDMemory_813EE358
...
/* 813EE554 | 4B FF FE 05 */	bl iplSDMemory_813EE358
...
.endfn iplSDMemory_813EE488

# .text:0x3060 | 0x813EE64C | size: 0x12C
.fn iplSDMemory_813EE64C, global
...
.endfn iplSDMemory_813EE64C

# .text:0x318C | 0x813EE778 | size: 0xA0
.fn iplSDMemory_813EE778, global
...
.endfn iplSDMemory_813EE778

# .text:0x322C | 0x813EE818 | size: 0x128
.fn iplSDMemory_813EE818, global
...
/* 813EE8C4 | 4B FF FA 95 */	bl iplSDMemory_813EE358
...
.endfn iplSDMemory_813EE818

# .text:0x3354 | 0x813EE940 | size: 0xE8
.fn iplSDMemory_813EE940, global
...
.endfn iplSDMemory_813EE940

# .text:0x343C | 0x813EEA28 | size: 0x84
.fn iplSDMemory_813EEA28, global
...
.endfn iplSDMemory_813EEA28

# .text:0x34C0 | 0x813EEAAC | size: 0xE8
.fn iplSDMemory_813EEAAC, global
...
.endfn iplSDMemory_813EEAAC

# .text:0x35A8 | 0x813EEB94 | size: 0x148
.fn iplSDMemory_813EEB94, global
...
.endfn iplSDMemory_813EEB94

# .text:0x36F0 | 0x813EECDC | size: 0x11C
.fn iplSDMemory_813EECDC, global
...
.endfn iplSDMemory_813EECDC

# .text:0x380C | 0x813EEDF8 | size: 0x78
.fn iplSDMemory_813EEDF8, global
...
.endfn iplSDMemory_813EEDF8

# .text:0x3884 | 0x813EEE70 | size: 0xC0
.fn iplSDMemory_813EEE70, global
...
.endfn iplSDMemory_813EEE70

# .text:0x3944 | 0x813EEF30 | size: 0x88
.fn iplSDMemory_813EEF30, global
...
/* 813EEFA0 | 48 00 00 19 */	bl iplSDMemory_813EEFB8
.L_813EEFA4:
...
.endfn iplSDMemory_813EEF30

# .text:0x39CC | 0x813EEFB8 | size: 0x70C
.fn iplSDMemory_813EEFB8, global
...
/* 813EF0D4 | 48 00 06 4D */	bl iplSDMemory_813EF720
...
/* 813EF0EC | 48 00 06 3D */	bl iplSDMemory_813EF728
...
/* 813EF100 | 48 00 06 31 */	bl iplSDMemory_813EF730
...
/* 813EF2C0 | 48 00 04 61 */	bl iplSDMemory_813EF720
...
/* 813EF2D8 | 48 00 04 51 */	bl iplSDMemory_813EF728
...
/* 813EF2EC | 48 00 04 45 */	bl iplSDMemory_813EF730
...
/* 813EF3AC | 48 00 03 19 */	bl iplSDMemory_813EF6C4
...
/* 813EF3FC | 48 00 02 DD */	bl iplSDMemory_813EF6D8
...
/* 813EF418 | 48 00 02 AD */	bl iplSDMemory_813EF6C4
...
/* 813EF468 | 48 00 02 71 */	bl iplSDMemory_813EF6D8
.L_813EF46C:
...
/* 813EF5C0 | 48 00 01 61 */	bl iplSDMemory_813EF720
...
/* 813EF5D8 | 48 00 01 51 */	bl iplSDMemory_813EF728
...
/* 813EF5EC | 48 00 01 45 */	bl iplSDMemory_813EF730
...
.endfn iplSDMemory_813EEFB8

# .text:0x40D8 | 0x813EF6C4 | size: 0x14
.fn iplSDMemory_813EF6C4, global
...
.endfn iplSDMemory_813EF6C4

# .text:0x40EC | 0x813EF6D8 | size: 0x48
.fn iplSDMemory_813EF6D8, global
...
.endfn iplSDMemory_813EF730

# .text:0x415C | 0x813EF748 | size: 0x74
.fn iplSDMemory_813EF748, global
...
.endfn iplSDMemory_813EF748

# .text:0x41D0 | 0x813EF7BC | size: 0x128
.fn iplSDMemory_813EF7BC, global
...
/* 813EF7DC | 4B FF FF 6D */	bl iplSDMemory_813EF748
...
.endfn iplSDMemory_813EF7BC

# .text:0x42F8 | 0x813EF8E4 | size: 0xF0
.fn iplSDMemory_813EF8E4, global
...
/* 813EF900 | 4B FF FE 49 */	bl iplSDMemory_813EF748
...
.endfn iplSDMemory_813EF8E4

# .text:0x43E8 | 0x813EF9D4 | size: 0x120
.fn iplSDMemory_813EF9D4, global
...
/* 813EF9F0 | 4B FF FD 59 */	bl iplSDMemory_813EF748
...
.endfn iplSDMemory_813EF9D4

# .text:0x4508 | 0x813EFAF4 | size: 0xD8
.fn iplSDMemory_813EFAF4, global
...
/* 813EFBB0 | 4B FF FE 25 */	bl iplSDMemory_813EF9D4
.L_813EFBB4:
...
.endfn iplSDMemory_813EFAF4

# .text:0x45E0 | 0x813EFBCC | size: 0xC0
.fn iplSDMemory_813EFBCC, global
...
.endfn iplSDMemory_813EFBCC

# .text:0x46A0 | 0x813EFC8C | size: 0x160
.fn iplSDMemory_813EFC8C, global
...
/* 813EFCAC | 4B FF FF 21 */	bl iplSDMemory_813EFBCC
...
.endfn iplSDMemory_813EFC8C

# .text:0x4800 | 0x813EFDEC | size: 0x128
.fn iplSDMemory_813EFDEC, global
...
/* 813EFE08 | 4B FF FD C5 */	bl iplSDMemory_813EFBCC
...
.endfn iplSDMemory_813EFDEC

# .text:0x4928 | 0x813EFF14 | size: 0x24C
.fn iplSDMemory_813EFF14, global
...
/* 813EFF30 | 4B FF FC 9D */	bl iplSDMemory_813EFBCC
...
.endfn iplSDMemory_813EFF14

# .text:0x4B74 | 0x813F0160 | size: 0xD8
.fn iplSDMemory_813F0160, global
...
/* 813F021C | 4B FF FC F9 */	bl iplSDMemory_813EFF14
.L_813F0220:
...
.endfn iplSDMemory_813F0160

# .text:0x4C4C | 0x813F0238 | size: 0x74
.fn iplSDMemory_813F0238, global
...
.endfn iplSDMemory_813F0238

# .text:0x4CC0 | 0x813F02AC | size: 0x144
.fn iplSDMemory_813F02AC, global
...
/* 813F02CC | 4B FF FF 6D */	bl iplSDMemory_813F0238
...
.endfn iplSDMemory_813F02AC

# .text:0x4E04 | 0x813F03F0 | size: 0x10C
.fn iplSDMemory_813F03F0, global
...
/* 813F040C | 4B FF FE 2D */	bl iplSDMemory_813F0238
...
.endfn iplSDMemory_813F03F0

# .text:0x4F10 | 0x813F04FC | size: 0x1A0
.fn iplSDMemory_813F04FC, global
...
/* 813F0518 | 4B FF FD 21 */	bl iplSDMemory_813F0238
...
.endfn iplSDMemory_813F04FC

# .text:0x50B0 | 0x813F069C | size: 0xD8
.fn iplSDMemory_813F069C, global
...
/* 813F0758 | 4B FF FD A5 */	bl iplSDMemory_813F04FC
.L_813F075C:
...
.obj jumptable_816566BC, local
	.rel iplSDMemory_813ED084, .L_813ED13C
	.rel iplSDMemory_813ED084, .L_813ED148
	.rel iplSDMemory_813ED084, .L_813ED168
	.rel iplSDMemory_813ED084, .L_813ED174
	.rel iplSDMemory_813ED084, .L_813ED184
	.rel iplSDMemory_813ED084, .L_813ED190
	.rel iplSDMemory_813ED084, .L_813ED1B0
	.rel iplSDMemory_813ED084, .L_813ED1BC
	.rel iplSDMemory_813ED084, .L_813ED1C8
	.rel iplSDMemory_813ED084, .L_813ED1D4
	.rel iplSDMemory_813ED084, .L_813ED1E0
	.rel iplSDMemory_813ED084, .L_813ED1EC
	.rel iplSDMemory_813ED084, .L_813ED1F8
	.rel iplSDMemory_813ED084, .L_813ED210
	.rel iplSDMemory_813ED084, .L_813ED21C
	.rel iplSDMemory_813ED084, .L_813ED228
	.rel iplSDMemory_813ED084, .L_813ED234
	.rel iplSDMemory_813ED084, .L_813ED240
	.rel iplSDMemory_813ED084, .L_813ED24C
	.rel iplSDMemory_813ED084, .L_813ED204
	.rel iplSDMemory_813ED084, .L_813ED258
	.rel iplSDMemory_813ED084, .L_813ED268
	.rel iplSDMemory_813ED084, .L_813ED274
	.rel iplSDMemory_813ED084, .L_813ED284
	.rel iplSDMemory_813ED084, .L_813ED290
	.rel iplSDMemory_813ED084, .L_813ED2A0
.endobj jumptable_816566BC

# .data:0xA84 | 0x81656724 | size: 0x5C
.obj jumptable_81656724, local
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED340
	.rel iplSDMemory_813ED2EC, .L_813ED340
	.rel iplSDMemory_813ED2EC, .L_813ED3BC
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED43C
	.rel iplSDMemory_813ED2EC, .L_813ED43C
	.rel iplSDMemory_813ED2EC, .L_813ED4B8
	.rel iplSDMemory_813ED2EC, .L_813ED67C
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED538
	.rel iplSDMemory_813ED2EC, .L_813ED538
	.rel iplSDMemory_813ED2EC, .L_813ED5EC
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED78C
	.rel iplSDMemory_813ED2EC, .L_813ED78C
