...
# 0x813D5564..0x813D6038 | size: 0xAD4
.text
.balign 4
...
.L_813D558C:
/* 813D558C | 80 0D AB 30 */	lwz r0, lbl_81698B70@sda21(r0)
...
/* 813D55A0 | 90 CD AB 30 */	stw r6, lbl_81698B70@sda21(r0)
...
/* 813D58F8 | 3F 40 81 69 */	lis r26, lbl_81696D20@ha
...
/* 813D5948 | 38 9A 6D 20 */	addi r4, r26, lbl_81696D20@l
...
# .text:0x928 | 0x813D5E8C | size: 0x44
.fn ipl_813D5E8C, global
...
# .text:0x96C | 0x813D5ED0 | size: 0x64
.fn ArrayFree, global
...
/* 813D5EF8 | 4B FF FF 95 */	bl ipl_813D5E8C
...
# .text:0xA08 | 0x813D5F6C | size: 0x7C
...
# .text:0xA84 | 0x813D5FE8 | size: 0x50
.fn SendPacket, global
/* 813D5FE8 | 94 21 FF F0 */	stwu r1, -0x10(r1)
/* 813D5FEC | 7C 08 02 A6 */	mflr r0
/* 813D5FF0 | 3C 60 81 0C */	lis r3, GSIACHostname@ha
...
/* 813D6004 | 3B E3 80 88 */	addi r31, r3, GSIACHostname@l
/* 813D6008 | 38 9F 00 0C */	addi r4, r31, 0xc
/* 813D600C | 80 63 80 88 */	lwz r3, GSIACHostname@l(r3)
