...
.fn FindNegotiatorForCookie, local
...
.endfn FindNegotiatorForCookie

# .text:0x80 | 0x813D6EB0 | size: 0x70
.fn RemoveNegotiator, local
...
.fn SendReportPacket, local
/* 813D6FC4 | 94 21 FF A0 */	stwu r1, -0x60(r1)
/* 813D6FC8 | 7C 08 02 A6 */	mflr r0
/* 813D6FCC | 38 8D 8C E0 */	li r4, NNMagicData@sda21
...
/* 813D700C | 80 8D 8C F0 */	lwz r4, natType@sda21(r0)
/* 813D7010 | 38 7F 80 08 */	addi r3, r31, __GSIACGamename@l
/* 813D7014 | 80 BE 00 0C */	lwz r5, 0xc(r30)
/* 813D7018 | 80 0D AB 74 */	lwz r0, natMappingScheme@sda21(r0)
...
/* 813D7078 | 4B FF FE DD */	bl SendPacket
...
.endfn SendReportPacket

# .text:0x264 | 0x813D7094 | size: 0xC0
.fn StartReport, local
...
/* 813D7118 | 4B FF FE AD */	bl SendReportPacket
...
/* 813D7174 | 38 8D 8C E0 */	li r4, NNMagicData@sda21
...
/* 813D72AC | 4B FF FC A9 */	bl SendPacket
.L_813D72B0:
...
/* 813D72E8 | 4B FF FC 6D */	bl SendPacket
.L_813D72EC:
...
/* 813D7378 | 4B FF FB DD */	bl SendPacket
.L_813D737C:
...
/* 813D73B4 | 4B FF FB A1 */	bl SendPacket
.L_813D73B8:
...
/* 813D7488 | 4B FF FA CD */	bl SendPacket
...
.endfn SendPingPacket

# .text:0x698 | 0x813D74C8 | size: 0x104
.fn CheckNatifyStatus, local
...
/* 813D74F0 | 80 0D AB 78 */	lwz r0, natifyStartTime@sda21(r0)
...
/* 813D756C | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
...
/* 813D7580 | 90 8D 8C F0 */	stw r4, natType@sda21(r0)
/* 813D7584 | 90 0D AB 74 */	stw r0, natMappingScheme@sda21(r0)
/* 813D7588 | 41 82 00 08 */	beq .L_813D7590
/* 813D758C | 4B FF EE 39 */	bl closesocket
.L_813D7590:
/* 813D7590 | 80 6D 8C EC */	lwz r3, ertSock@sda21(r0)
/* 813D7594 | 38 00 FF FF */	li r0, -0x1
/* 813D7598 | 90 0D 8C E8 */	stw r0, mappingSock@sda21(r0)
...
/* 813D75AC | 90 0D 8C EC */	stw r0, ertSock@sda21(r0)
.L_813D75B0:
...
/* 813D7688 | 4B FF FF 45 */	bl NameToIp
...
/* 813D76A4 | 4B FF FF 29 */	bl NameToIp
...
/* 813D76C0 | 4B FF FF 0D */	bl NameToIp
...
.L_813D7738:
/* 813D7738 | 4B FF FF 25 */	bl ResolveServers
...
/* 813D7754 | 93 ED AB 70 */	stw r31, activeNatify@sda21(r0)
/* 813D7758 | 4B FF F0 E1 */	bl current_time
/* 813D775C | 3C C0 81 0C */	lis r6, nat@ha
/* 813D7760 | 90 6D AB 78 */	stw r3, natifyStartTime@sda21(r0)
...
/* 813D7780 | 90 6D 8C EC */	stw r3, ertSock@sda21(r0)
...
/* 813D7794 | 90 6D 8C E8 */	stw r3, mappingSock@sda21(r0)
/* 813D7798 | 38 A0 6C FD */	li r5, 0x6cfd
/* 813D779C | 80 6D 8C EC */	lwz r3, ertSock@sda21(r0)
...
/* 813D77AC | 80 6D 8C EC */	lwz r3, ertSock@sda21(r0)
...
/* 813D77C0 | 80 6D 8C EC */	lwz r3, ertSock@sda21(r0)
...
/* 813D77D4 | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
...
/* 813D77EC | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
...
/* 813D7804 | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
...
/* 813D781C | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
...
/* 813D7860 | 4B FF F5 D1 */	bl FindNegotiatorForCookie
...
/* 813D78C0 | 80 0D AB 70 */	lwz r0, activeNatify@sda21(r0)
/* 813D78C4 | 90 81 00 08 */	stw r4, 0x8(r1)
/* 813D78C8 | 2C 00 00 00 */	cmpwi r0, 0x0
/* 813D78CC | 41 82 00 1C */	beq .L_813D78E8
/* 813D78D0 | 80 6D 8C E8 */	lwz r3, mappingSock@sda21(r0)
/* 813D78D4 | 4B FF FB F5 */	bl CheckNatifyStatus
/* 813D78D8 | 90 6D AB 70 */	stw r3, activeNatify@sda21(r0)
/* 813D78DC | 80 6D 8C EC */	lwz r3, ertSock@sda21(r0)
/* 813D78E0 | 4B FF FB E9 */	bl CheckNatifyStatus
/* 813D78E4 | 90 6D AB 70 */	stw r3, activeNatify@sda21(r0)
.L_813D78E8:
...
/* 813D7900 | 4B FF F5 B1 */	bl RemoveNegotiator
...
/* 813D7914 | 3F C0 81 0C */	lis r30, indata$2729@ha
.L_813D7918:
...
/* 813D7928 | 38 9E 81 C8 */	addi r4, r30, indata$2729@l
...
/* 813D7958 | 38 7E 81 C8 */	addi r3, r30, indata$2729@l
...
/* 813D79CC | 4B FF F6 C9 */	bl StartReport
...
/* 813D79E4 | 4B FF F6 B1 */	bl StartReport
...
/* 813D7A04 | 4B FF F7 51 */	bl SendInitPackets
/* 813D7A08 | 48 00 00 0C */	b .L_813D7A14
.L_813D7A0C:
/* 813D7A0C | 7F E3 FB 78 */	mr r3, r31
/* 813D7A10 | 4B FF F9 D5 */	bl SendPingPacket
.L_813D7A14:
...
/* 813D7A68 | 4B FF F6 2D */	bl StartReport
.L_813D7A6C:
...
/* 813D7A98 | 4B FF F5 FD */	bl StartReport
.L_813D7A9C:
...
/* 813D7AFC | 4B FF F4 C9 */	bl SendReportPacket
...
/* 813D7B5C | 4B FF FD 49 */	bl NegotiateThink
...
/* 813D7B80 | 4B FF FD 25 */	bl NegotiateThink
...
/* 813D7BC4 | 38 8D 8C E0 */	li r4, NNMagicData@sda21
...
/* 813D7C28 | 4B FF F2 09 */	bl FindNegotiatorForCookie
...
/* 813D7C80 | 38 8D 8C E0 */	li r4, NNMagicData@sda21
...
/* 813D7CD0 | 4B FF F2 85 */	bl SendPacket
.L_813D7CD4:
...
/* 813D7D18 | 4B FF F3 7D */	bl StartReport
...
/* 813D7D5C | 4B FF F6 89 */	bl SendPingPacket
...
/* 813D7DB4 | 4B FF F6 31 */	bl SendPingPacket
...
/* 813D7DD8 | 4B FF F6 0D */	bl SendPingPacket
.L_813D7DDC:
...
/* 813D7E08 | 4B FF F2 8D */	bl StartReport
...
/* 813D7E20 | 4B FF F5 C5 */	bl SendPingPacket
...
/* 813D7E48 | 4B FF EF E9 */	bl FindNegotiatorForCookie
...
/* 813D7F3C | 4B FF F0 19 */	bl SendPacket
...
# .data:0x0 | 0x81653858 | size: 0x54
.obj lbl_81653858, global
	.string "natneg1.gs.nintendowifi.net\000natneg2.gs.nintendowifi.net\000natneg3.gs.nintendowifi.net"
.endobj lbl_81653858

# .data:0x54 | 0x816538AC | size: 0x4
.obj gap_08_816538AC_data, global
.hidden gap_08_816538AC_data
	.4byte 0x00000000
.endobj gap_08_816538AC_data

# 0x81696D20..0x81696D40 | size: 0x20
.section .sdata, "wa"
.balign 8

# .sdata:0x0 | 0x81696D20 | size: 0x6
.obj NNMagicData, global
	.4byte 0xFDFC1E66
	.2byte 0x6AB2
.endobj NNMagicData

# .sdata:0x6 | 0x81696D26 | size: 0x2
.obj gap_11_81696D26_sdata, global
.hidden gap_11_81696D26_sdata
	.2byte 0x0000
.endobj gap_11_81696D26_sdata

# .sdata:0x8 | 0x81696D28 | size: 0x4
.obj mappingSock, global
	.4byte 0xFFFFFFFF
.endobj mappingSock
...
# .sdata:0x14 | 0x81696D34 | size: 0x6
.obj lbl_81696D34, global
	.string "%s.%s"
.endobj lbl_81696D34

# .sdata:0x1A | 0x81696D3A | size: 0x6
.obj gap_11_81696D3A_sdata, global
.hidden gap_11_81696D3A_sdata
	.4byte 0x00000000
	.2byte 0x0000
.endobj gap_11_81696D3A_sdata
...
.obj activeNatify, local
	.skip 0x4
.endobj activeNatify

# .sbss:0x14 | 0x81698BB4 | size: 0x4
.obj natMappingScheme, local
	.skip 0x4
.endobj natMappingScheme

# .sbss:0x18 | 0x81698BB8 | size: 0x4
.obj natifyStartTime, local
	.skip 0x4
.endobj natifyStartTime

# .sbss:0x1C | 0x81698BBC | size: 0x4
.obj natifyCallback, local
	.skip 0x4
