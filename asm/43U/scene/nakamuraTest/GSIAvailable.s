...
.obj GSIACHostname, global
	.skip 0x58
.endobj GSIACHostname

# 0x813D6038..0x813D6328 | size: 0x2F0
.text
.balign 4

# .text:0x0 | 0x813D6038 | size: 0x150
...
# .text:0x150 | 0x813D6188 | size: 0x1A0
...
/* 813D619C | 3F E0 81 0C */	lis r31, GSIACHostname@ha
/* 813D61A0 | 80 7F 80 88 */	lwz r3, GSIACHostname@l(r31)
...
/* 813D61CC | 80 7F 80 88 */	lwz r3, GSIACHostname@l(r31)
...
.L_813D61F8:
/* 813D61F8 | 3B FF 80 88 */	addi r31, r31, GSIACHostname@l
...
/* 813D6284 | 3C 60 81 0C */	lis r3, GSIACHostname@ha
/* 813D6288 | 80 63 80 88 */	lwz r3, GSIACHostname@l(r3)
...
/* 813D62C4 | 3C A0 81 0C */	lis r5, GSIACHostname@ha
/* 813D62C8 | 3B E5 80 88 */	addi r31, r5, GSIACHostname@l
...
/* 813D62E8 | 80 65 80 88 */	lwz r3, GSIACHostname@l(r5)
