...
/* 813FE414 | 48 0B 42 1D */	bl fn_814B2630
...
/* 813FE47C | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
.L_813FE6B0:
/* 813FE6B0 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
.L_813FE7A8:
/* 813FE7A8 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FE830 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
.L_813FEA94:
/* 813FEA94 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FEB1C | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FED04 | 48 0B 53 61 */	bl SOGetSockOpt
...
/* 813FED28 | 48 0B 44 D9 */	bl fn_814B3200
...
/* 813FEE18 | 48 0B 38 19 */	bl fn_814B2630
...
.L_813FEFEC:
/* 813FEFEC | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FF074 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FF140 | 48 0B 4F 25 */	bl SOGetSockOpt
...
/* 813FF160 | 48 0B 40 A1 */	bl fn_814B3200
...
/* 813FF308 | 48 0B 48 6D */	bl fn_814B3B74
...
.L_813FF488:
/* 813FF488 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FF510 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FF588 | 48 0B 45 E5 */	bl fn_814B3B6C
...
/* 813FF604 | 48 0B 30 2D */	bl fn_814B2630
...
.L_813FF6E4:
/* 813FF6E4 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
.L_813FF8AC:
/* 813FF8AC | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FF934 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FFA28 | 48 0B 46 3D */	bl SOGetSockOpt
...
/* 813FFA48 | 48 0B 37 B9 */	bl fn_814B3200
...
.L_813FFAF0:
/* 813FFAF0 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FFB78 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 813FFBF0 | 48 0B 2A 41 */	bl fn_814B2630
...
/* 814001E4 | 48 0B 39 89 */	bl fn_814B3B6C
...
/* 81400250 | 48 0B 39 1D */	bl fn_814B3B6C
...
/* 81400370 | 48 0B 37 FD */	bl fn_814B3B6C
/* 81400374 | 7C 7E 1B 78 */	mr r30, r3
/* 81400378 | A0 7C 00 06 */	lhz r3, 0x6(r28)
/* 8140037C | 48 0B 37 F1 */	bl fn_814B3B6C
...
/* 814003B8 | 48 0B 37 B5 */	bl fn_814B3B6C
...
/* 814003EC | 48 0B 37 7D */	bl fn_814B3B68
...
/* 8140040C | 48 0B 37 5D */	bl fn_814B3B68
...
/* 81400494 | 48 0B 36 D9 */	bl fn_814B3B6C
...
/* 8140055C | 48 0B 36 11 */	bl fn_814B3B6C
/* 81400560 | 7C 7D 1B 78 */	mr r29, r3
/* 81400564 | A0 79 00 0E */	lhz r3, 0xe(r25)
/* 81400568 | 48 0B 36 05 */	bl fn_814B3B6C
...
/* 814005A4 | 48 0B 35 C9 */	bl fn_814B3B6C
...
/* 814005D4 | 48 0B 35 95 */	bl fn_814B3B68
...
/* 814005F4 | 48 0B 35 75 */	bl fn_814B3B68
...
/* 8140062C | 48 0B 35 41 */	bl fn_814B3B6C
...
/* 81400724 | 48 0B 34 49 */	bl fn_814B3B6C
/* 81400728 | 7C 7F 1B 78 */	mr r31, r3
/* 8140072C | A0 7D 00 16 */	lhz r3, 0x16(r29)
/* 81400730 | 48 0B 34 3D */	bl fn_814B3B6C
...
/* 8140078C | 48 0B 33 E1 */	bl fn_814B3B6C
...
/* 814007B0 | 48 0B 33 B9 */	bl fn_814B3B68
...
/* 814007C8 | 48 0B 33 A1 */	bl fn_814B3B68
...
/* 814007EC | 48 0B 33 7D */	bl fn_814B3B68
...
/* 81400894 | 48 0B 32 D9 */	bl fn_814B3B6C
...
/* 814008B4 | 48 0B 32 B9 */	bl fn_814B3B6C
...
/* 814008D8 | 48 0B 32 95 */	bl fn_814B3B6C
...
/* 814008F0 | 48 0B 32 7D */	bl fn_814B3B6C
...
/* 81400E4C | 48 0B 2D 21 */	bl fn_814B3B6C
...
/* 81400ED0 | 48 0B 2C 9D */	bl fn_814B3B6C
...
.L_81400FC8:
/* 81400FC8 | 48 0B 2B A1 */	bl fn_814B3B68
...
.L_814010B8:
/* 814010B8 | 48 0B 2A B1 */	bl fn_814B3B68
...
/* 814010D8 | 48 0B 2A 95 */	bl fn_814B3B6C
...
/* 81401130 | 48 0B 2A 3D */	bl fn_814B3B6C
...
/* 81401254 | 48 0B 29 19 */	bl fn_814B3B6C
...
/* 814012B0 | 48 0B 28 BD */	bl fn_814B3B6C
...
/* 8140137C | 48 0B 27 F1 */	bl fn_814B3B6C
...
/* 81401400 | 48 0B 27 6D */	bl fn_814B3B6C
...
/* 81401428 | 48 0B 27 45 */	bl fn_814B3B6C
...
/* 814014DC | 48 0B 26 91 */	bl fn_814B3B6C
...
/* 8140152C | 48 0B 26 41 */	bl fn_814B3B6C
...
/* 8140171C | 48 0B 24 59 */	bl fn_814B3B74
...
/* 814017F0 | 48 0B 23 85 */	bl fn_814B3B74
...
/* 81401B64 | 48 0B 20 11 */	bl fn_814B3B74
...
/* 81401C58 | 48 0B 1F 1D */	bl fn_814B3B74
...
.L_814020FC:
/* 814020FC | 48 0B 01 01 */	bl fn_814B21FC
...
.L_81402120:
/* 81402120 | 80 0D AB F8 */	lwz r0, lbl_81698C38@sda21(r0)
...
/* 81402154 | 48 0B 04 DD */	bl fn_814B2630
.L_81402158:
...
.L_81402184:
/* 81402184 | 48 0B 1E E1 */	bl SOGetSockOpt
...
/* 81402268 | 48 09 04 51 */	bl fn_814926B8
...
/* 814022B4 | 48 09 01 99 */	bl fn_8149244C
...
/* 81402334 | 48 12 A8 11 */	bl fn_8152CB44
...
.L_81402348:
/* 81402348 | 48 09 08 79 */	bl fn_81492BC0
...
/* 8140235C | 48 0A FE A1 */	bl fn_814B21FC
...
/* 814023D4 | 48 12 A7 71 */	bl fn_8152CB44
...
/* 814023EC | 48 0B 17 89 */	bl fn_814B3B74
/* 814023F0 | 7C 7F 1B 78 */	mr r31, r3
/* 814023F4 | 48 0B 1C 71 */	bl SOGetSockOpt
...
/* 81402460 | 48 09 08 CD */	bl fn_81492D2C
...
/* 81402484 | 48 0D 76 05 */	bl fn_814D9A88
...
/* 814024E0 | 48 12 A6 65 */	bl fn_8152CB44
...
/* 814024FC | 48 0D 74 B9 */	bl fn_814D99B4
...
/* 8140258C | 48 0D 73 45 */	bl fn_814D98D0
...
/* 81402610 | 48 12 A5 35 */	bl fn_8152CB44
...
/* 8140269C | 48 12 A4 A9 */	bl fn_8152CB44
...
.L_814026B0:
/* 814026B0 | 48 0D 74 BD */	bl fn_814D9B6C
...
/* 81402728 | 48 12 A4 1D */	bl fn_8152CB44
...
/* 81402740 | 48 09 06 F1 */	bl fn_81492E30
...
/* 814030A4 | 48 0B 0A C9 */	bl fn_814B3B6C
...
/* 81403220 | 48 08 F9 E1 */	bl fn_81492C00
...
/* 81403410 | 48 0B 07 5D */	bl fn_814B3B6C
...
/* 8140347C | 48 0B 06 F1 */	bl fn_814B3B6C
...
/* 81403490 | 48 0B 06 DD */	bl fn_814B3B6C
...
/* 814034B0 | 48 0B 06 BD */	bl fn_814B3B6C
...
/* 814034D0 | 48 0B 06 9D */	bl fn_814B3B6C
...
/* 81403980 | 48 12 91 C5 */	bl fn_8152CB44
...
/* 81403B1C | 48 0A F6 E5 */	bl fn_814B3200
...
/* 81404000 | 48 0A FB 6D */	bl fn_814B3B6C
...
/* 81404080 | 48 0A FA ED */	bl fn_814B3B6C
...
/* 814044C8 | 48 0A F6 A5 */	bl fn_814B3B6C
...
/* 81404660 | 48 08 E4 5D */	bl fn_81492ABC
...
/* 814047E8 | 48 0A DE 49 */	bl fn_814B2630
.L_814047EC:
...
/* 81406A84 | 48 12 60 C1 */	bl fn_8152CB44
...
/* 81406B00 | 48 12 60 45 */	bl fn_8152CB44
