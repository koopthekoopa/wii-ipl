BS2_OBJECTS =	$(BS2_OBJ_PATH)/BS2/BootStart.o \
				...
				$(BS2_SPLIT_PATH)/BS2/BS2Mach.o \
				$(BS2_SPLIT_PATH)/BS2/BS2Update.o \
				$(BS2_SPLIT_PATH)/BS2/BS2ParentalControl.o \
				$(BS2_SPLIT_PATH)/BS2/BringUp.o \
				$(BS2_SPLIT_PATH)/BS2/BS2Reset.o \
				$(BS2_SPLIT_PATH)/BS2/BS2Fatal.o
