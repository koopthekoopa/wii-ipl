...
config.libs = [
    ...
    IPLSection("keyboard", [
            ...
            Object(NonMatching, "keyboard/tiCpData.cpp", extra_cflags=["-O4,p"]),
            Object(NonMatching, "keyboard/tiSwData.cpp", extra_cflags=["-O4,p"]),
            Object(NonMatching, "keyboard/tiPkData.cpp", extra_cflags=["-O4,p"]),
            Object(NonMatching, "keyboard/tiLanguageIndependentData.cpp", extra_cflags=["-O4,p"]),
